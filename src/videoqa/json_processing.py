...
def process_all_shot_features(base_dir=None):
    ...
    # Input directory
    input_dir = base_dir / "processed_videos_output_module2_2_scenes"
    
    # Create output directory for Excel files if it doesn't exist
    output_dir = base_dir / "excel_output_module2_2_scenes"
